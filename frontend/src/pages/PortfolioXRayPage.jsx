...
const PortfolioXRayPage = () => {
  ...
  const steps = [
    "Connecting to Portfolio X-Ray Agent...",
    "Scanning mutual fund holdings and AUM...",
    "Analyzing TER (Expense Ratio) efficiency...",
    "Checking for stock overlap and concentration...",
    ...
    return (
      <div className="flex flex-col items-center justify-center h-full space-y-4">
        ...
        <div className="text-center">
            ...
            <p className="text-sm text-gray-500 mt-1">Our AI is analyzing your mutual funds</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto w-full">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-serif font-bold text-gray-900">Portfolio X-Ray</h1>
