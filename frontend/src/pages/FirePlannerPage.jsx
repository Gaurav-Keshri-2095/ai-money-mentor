...
const FirePlannerPage = () => {
  const [profile, setProfile] = useState(null);
  const [isLoading, setIsLoading] = useState(true);
  const [loadingStep, setLoadingStep] = useState(0);

  const steps = [
    "Connecting to FIRE Planner Agent...",
    "Reviewing current assets and SIP amounts...",
    "Projecting corpus growth with inflation...",
    "Simulating early retirement scenarios...",
    "Finalizing your path to Financial Independence..."
  ];
    ...
    return (
      <div className="flex flex-col items-center justify-center h-full space-y-4">
        ...
        <div className="text-center">
            ...
            <p className="text-sm text-gray-500 mt-1">Our AI is simulating your retirement</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto w-full">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-serif font-bold text-gray-900">FIRE Planner</h1>
